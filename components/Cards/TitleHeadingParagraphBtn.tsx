...
interface TitleHeadingParagraphBtnProps {
  title: string;
  heading: string;
  paragraph: string;
  buttonText: string;
...
const TitleHeadingParagraphBtn: React.FC<TitleHeadingParagraphBtnProps> = ({
  title,
  heading,
  paragraph,
  buttonText,
    ...
    <div className={`relative ${className}`}>
      ...
      >
        ...
        <div className="animate-slide-in-left">
          <span
            className="
            text-primary text-lg md:text-xl font-semibold uppercase tracking-wide
            transition-all duration-300 hover:scale-105 transform inline-block
          "
          >
            {title}
          </span>
...
export default TitleHeadingParagraphBtn;
